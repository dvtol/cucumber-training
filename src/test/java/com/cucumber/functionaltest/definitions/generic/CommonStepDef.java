...
public class CommonStepDef extends BaseStepDef {
    ...
    @Given("^the user opens the Cucumber training test app$")
    public void loginCucumberTrainingTestEnv() throws AWTException, IOException {
    ...
    public void clickOnTheEditButton() {
        commonObjPage.clickOnEditButton();
    }
